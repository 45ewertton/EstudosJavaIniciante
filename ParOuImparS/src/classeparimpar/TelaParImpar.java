...
public class TelaParImpar extends javax.swing.JFrame {
    ...
    public TelaParImpar() {
        initComponents();
        lblResult.setText("O número é par ou ímpar?");
    }
    ...
    private void initComponents() {
        ...
        btnVerificar.setText("Verificar valor");
    ...
    private void btnVerificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVerificarActionPerformed
        ...
        if (valor % 2 == 0){
            lblResult.setText("O valor selecionado é par!!!");
        }else {
            lblResult.setText("O valor selecionado é ímpar!!!");
        }
