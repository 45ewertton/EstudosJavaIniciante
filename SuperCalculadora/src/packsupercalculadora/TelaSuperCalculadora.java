...
public class TelaSuperCalculadora extends javax.swing.JFrame {
     ...
     */
    public TelaSuperCalculadora() { //Contrutor (Método com mesmo nome da classe)
        initComponents();
    ...
    private void btnCalcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcActionPerformed
        ...
        int valorResto = valor % 2;
        lblResto.setText(Integer.toString(valorResto));
        
        double valorCubo = Math.pow(valor, 3);
        lblCubo.setText(Double.toString(valorCubo));
        
        double valorRaizQ = Math.sqrt(valor);
        lblRaizQ.setText(String.format("%.2f", valorRaizQ));
        
        double valorRaizC = Math.cbrt(valor);
        lblRaizC.setText(String.format("%.2f", valorRaizC));
